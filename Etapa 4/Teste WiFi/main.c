...
// Credenciais Wi-Fi
#define WIFI_SSID "Laura M 2.4Ghz"     // Nome da rede Wi-Fi
#define WIFI_PASS "13l31s16a"          // Senha da rede Wi-Fi

// URL do servidor Python
#define SERVER_URL "http://192.168.0.15:5000/receive_data" // Endereço do backend
